...
if __name__ == "__main__":
    ...
    poseZonaRobo = [0.16567, 0.57124, 0.51001, 2.466, -2.271, -2.510]
    poseZonaFichas = [-0.3185, 0.45191, 0.51014, 2.392, -2.316, -2.464]
    poseZonaTablero = [-0.07651, 0.59647, 0.520, 2.445, -2.339, -2.471]
